...
/**
 * ChannelProductReferencesRequest Class Doc Comment
 *
 * @category Class
 * @package  ChannelEngine\Channel\ApiClient
 * @author   OpenAPI Generator team
 ...
 */
class ChannelProductReferencesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelProductReferencesRequest';
     ...
     * Sets id
     *
     * @param int|null $id The unique ChannelEngine product ID.
     *
     * @return self
     */
