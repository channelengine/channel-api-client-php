 ...
 */
class ChannelProductChangesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['toBeCreated'] = $data['toBeCreated'] ?? null;
        $this->container['toBeUpdated'] = $data['toBeUpdated'] ?? null;
        $this->container['toBeRemoved'] = $data['toBeRemoved'] ?? null;
    }
