 ...
 */
class ChannelReturnLineRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ChannelReturnLineRequest., must be bigger than or equal to 0.');
        }
