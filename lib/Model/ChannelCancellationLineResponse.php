 ...
 */
class ChannelCancellationLineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelCancellationLineResponse';
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ChannelCancellationLineResponse., must be bigger than or equal to 0.');
        }
