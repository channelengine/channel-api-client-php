 ...
 * @link     https://openapi-generator.tech
 */
class ChannelProductResponse implements ModelInterface, ArrayAccess
{
     ...
     * Sets mappedFields
     *
     * @param map[string,string]|null $mappedFields A channel can require certain fields to be available. The channel  can provide ChannelEngine with this fields after which the merchants  will be able to fill in this field using custom conditions in ChannelEngine.
     *
     * @return $this
     */
