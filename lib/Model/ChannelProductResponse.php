...
class ChannelProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'productType' => '\ChannelEngine\Channel\ApiClient\Model\ProductType',
     ...
     *
     * @param string|null $channelProductNo The unique product reference used by the Channel for the product.
     *
     * @return self
     */
     ...
     * Gets productType
     *
     * @return \ChannelEngine\Channel\ApiClient\Model\ProductType|null
     */
     ...
     * Sets productType
     *
     * @param \ChannelEngine\Channel\ApiClient\Model\ProductType|null $productType productType
     *
     * @return self
     */
    ...
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 256)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ChannelProductResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($name) && (mb_strlen($name) < 0)) {
            throw new \InvalidArgumentException('invalid length for $name when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setBrand($brand)
    {
        if (!is_null($brand) && (mb_strlen($brand) > 256)) {
            throw new \InvalidArgumentException('invalid length for $brand when calling ChannelProductResponse., must be smaller than or equal to 256.');
        }
        if (!is_null($brand) && (mb_strlen($brand) < 0)) {
            throw new \InvalidArgumentException('invalid length for $brand when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setSize($size)
    {
        if (!is_null($size) && (mb_strlen($size) > 64)) {
            throw new \InvalidArgumentException('invalid length for $size when calling ChannelProductResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($size) && (mb_strlen($size) < 0)) {
            throw new \InvalidArgumentException('invalid length for $size when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setColor($color)
    {
        if (!is_null($color) && (mb_strlen($color) > 64)) {
            throw new \InvalidArgumentException('invalid length for $color when calling ChannelProductResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($color) && (mb_strlen($color) < 0)) {
            throw new \InvalidArgumentException('invalid length for $color when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setEan($ean)
    {
        if (!is_null($ean) && (mb_strlen($ean) > 64)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling ChannelProductResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($ean) && (mb_strlen($ean) < 0)) {
            throw new \InvalidArgumentException('invalid length for $ean when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setManufacturerProductNumber($manufacturerProductNumber)
    {
        if (!is_null($manufacturerProductNumber) && (mb_strlen($manufacturerProductNumber) > 64)) {
            throw new \InvalidArgumentException('invalid length for $manufacturerProductNumber when calling ChannelProductResponse., must be smaller than or equal to 64.');
        }
        if (!is_null($manufacturerProductNumber) && (mb_strlen($manufacturerProductNumber) < 0)) {
            throw new \InvalidArgumentException('invalid length for $manufacturerProductNumber when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setMerchantProductNo($merchantProductNo)
    {
        if ((mb_strlen($merchantProductNo) > 64)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling ChannelProductResponse., must be smaller than or equal to 64.');
        }
        if ((mb_strlen($merchantProductNo) < 0)) {
            throw new \InvalidArgumentException('invalid length for $merchantProductNo when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setStock($stock)
    {
        ...
        if (!is_null($stock) && ($stock < 0)) {
            throw new \InvalidArgumentException('invalid value for $stock when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setPrice($price)
    {
        ...
        if (!is_null($price) && ($price < 0)) {
            throw new \InvalidArgumentException('invalid value for $price when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setShippingTime($shippingTime)
    {
        if (!is_null($shippingTime) && (mb_strlen($shippingTime) > 128)) {
            throw new \InvalidArgumentException('invalid length for $shippingTime when calling ChannelProductResponse., must be smaller than or equal to 128.');
        }
        if (!is_null($shippingTime) && (mb_strlen($shippingTime) < 0)) {
            throw new \InvalidArgumentException('invalid length for $shippingTime when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setUrl($url)
    {
        if (!is_null($url) && (mb_strlen($url) > 512)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($url) && (mb_strlen($url) < 0)) {
            throw new \InvalidArgumentException('invalid length for $url when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setImageUrl($imageUrl)
    {
        if (!is_null($imageUrl) && (mb_strlen($imageUrl) > 512)) {
            throw new \InvalidArgumentException('invalid length for $imageUrl when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($imageUrl) && (mb_strlen($imageUrl) < 0)) {
            throw new \InvalidArgumentException('invalid length for $imageUrl when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl1($extraImageUrl1)
    {
        if (!is_null($extraImageUrl1) && (mb_strlen($extraImageUrl1) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl1 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl1) && (mb_strlen($extraImageUrl1) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl1 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl2($extraImageUrl2)
    {
        if (!is_null($extraImageUrl2) && (mb_strlen($extraImageUrl2) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl2 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl2) && (mb_strlen($extraImageUrl2) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl2 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl3($extraImageUrl3)
    {
        if (!is_null($extraImageUrl3) && (mb_strlen($extraImageUrl3) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl3 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl3) && (mb_strlen($extraImageUrl3) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl3 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl4($extraImageUrl4)
    {
        if (!is_null($extraImageUrl4) && (mb_strlen($extraImageUrl4) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl4 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl4) && (mb_strlen($extraImageUrl4) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl4 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl5($extraImageUrl5)
    {
        if (!is_null($extraImageUrl5) && (mb_strlen($extraImageUrl5) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl5 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl5) && (mb_strlen($extraImageUrl5) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl5 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl6($extraImageUrl6)
    {
        if (!is_null($extraImageUrl6) && (mb_strlen($extraImageUrl6) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl6 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl6) && (mb_strlen($extraImageUrl6) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl6 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl7($extraImageUrl7)
    {
        if (!is_null($extraImageUrl7) && (mb_strlen($extraImageUrl7) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl7 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl7) && (mb_strlen($extraImageUrl7) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl7 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl8($extraImageUrl8)
    {
        if (!is_null($extraImageUrl8) && (mb_strlen($extraImageUrl8) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl8 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl8) && (mb_strlen($extraImageUrl8) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl8 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setExtraImageUrl9($extraImageUrl9)
    {
        if (!is_null($extraImageUrl9) && (mb_strlen($extraImageUrl9) > 512)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl9 when calling ChannelProductResponse., must be smaller than or equal to 512.');
        }
        if (!is_null($extraImageUrl9) && (mb_strlen($extraImageUrl9) < 0)) {
            throw new \InvalidArgumentException('invalid length for $extraImageUrl9 when calling ChannelProductResponse., must be bigger than or equal to 0.');
        }
