 ...
 */
class ChannelProductExtraDataItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChannelProductExtraDataItemResponse';
    ...
    protected static $openAPITypes = [
        'key' => 'string',
        'value' => 'string',
        'type' => '\ChannelEngine\Channel\ApiClient\Model\ExtraDataType',
        'isPublic' => 'bool'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['value']) && (mb_strlen($this->container['value']) > -1)) {
            $invalidProperties[] = "invalid value for 'value', the character length must be smaller than or equal to -1.";
        }
    ...
    public function setKey($key)
    {
        if (!is_null($key) && (mb_strlen($key) > 100)) {
            throw new \InvalidArgumentException('invalid length for $key when calling ChannelProductExtraDataItemResponse., must be smaller than or equal to 100.');
        }
        if (!is_null($key) && (mb_strlen($key) < 0)) {
            throw new \InvalidArgumentException('invalid length for $key when calling ChannelProductExtraDataItemResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setValue($value)
    {
        if (!is_null($value) && (mb_strlen($value) > -1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling ChannelProductExtraDataItemResponse., must be smaller than or equal to -1.');
        }
     ...
     * Gets type
     *
     * @return \ChannelEngine\Channel\ApiClient\Model\ExtraDataType|null
     */
     ...
     * Sets type
     *
     * @param \ChannelEngine\Channel\ApiClient\Model\ExtraDataType|null $type type
     *
     * @return self
     */
