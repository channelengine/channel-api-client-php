...
class ChannelOrderLineResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setChannelProductNo($channelProductNo)
    {
        if ((mb_strlen($channelProductNo) > 60)) {
            throw new \InvalidArgumentException('invalid length for $channelProductNo when calling ChannelOrderLineResponse., must be smaller than or equal to 60.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (($quantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling ChannelOrderLineResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setCancellationRequestedQuantity($cancellationRequestedQuantity)
    {
        ...
        if (!is_null($cancellationRequestedQuantity) && ($cancellationRequestedQuantity < 0)) {
            throw new \InvalidArgumentException('invalid value for $cancellationRequestedQuantity when calling ChannelOrderLineResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setUnitPriceInclVat($unitPriceInclVat)
    {
        ...
        if (($unitPriceInclVat < 0)) {
            throw new \InvalidArgumentException('invalid value for $unitPriceInclVat when calling ChannelOrderLineResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setFeeFixed($feeFixed)
    {
        ...
        if (!is_null($feeFixed) && ($feeFixed < 0)) {
            throw new \InvalidArgumentException('invalid value for $feeFixed when calling ChannelOrderLineResponse., must be bigger than or equal to 0.');
        }
    ...
    public function setFeeRate($feeRate)
    {
        ...
        if (!is_null($feeRate) && ($feeRate < 0)) {
            throw new \InvalidArgumentException('invalid value for $feeRate when calling ChannelOrderLineResponse., must be bigger than or equal to 0.');
        }
