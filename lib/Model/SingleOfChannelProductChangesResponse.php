 ...
 */
class SingleOfChannelProductChangesResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SingleOfChannelProductChangesResponse';
