...
namespace ChannelEngine\Channel\ApiClient;
...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/2.9.10/PHP';
    ...
    {
        $report  = 'PHP SDK (ChannelEngine\Channel\ApiClient) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.9.10' . PHP_EOL;
        $report .= '    SDK Package Version: 2.9.10' . PHP_EOL;
